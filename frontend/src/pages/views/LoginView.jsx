...
const LoginView = () => {
  ...
  return (
    ...
    <div className="mt-6 flex items-center justify-center gap-x-6 lg:justify-center ">
      <GoogleLogin
        ...
        render={renderProps => (
          <button
            ...
            className="flex w-full justify-center rounded-md bg-white px-1 py-1.5 text-sm/6 font-semibold text-black shadow-xs focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-100 items-center justify-content-center gap-x-2"
            type="button"
          >
      ...
      <button type="button" onClick={handleFacebookLogin} className="flex w-full justify-center rounded-md bg-white px-1 py-1.5 text-sm/6 font-semibold text-black shadow-xs focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-100 items-center justify-content-center gap-x-2">
