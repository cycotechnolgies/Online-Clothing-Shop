...
const OrderHistory = () => {
  ...
  return (
    <section className="bg-white rounded-2xl shadow-sm p-6 md:p-8 lg:col-span-8 min-w-0">
      ...
      {/* Tabs */}
      <div className="flex flex-wrap gap-4 text-gray-600 mt-6 mb-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <input
          ...
          className="border rounded-lg px-4 py-2.5 w-full md:w-2/3 focus:outline-none focus:ring-2 focus:ring-black"
        />
      </div>

      {/* Orders Table */}
      <div className="bg-white shadow rounded-xl overflow-hidden">
        <div className="overflow-x-auto"> {/* This will enable horizontal scrolling */}
